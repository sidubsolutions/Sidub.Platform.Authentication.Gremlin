...
namespace Sidub.Platform.Authentication
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds Sidub authentication for Gremlin.
        /// </summary>
        /// <param name="services">The <see cref="IServiceCollection"/> to add the authentication services to.</param>
        /// <returns>The modified <see cref="IServiceCollection"/>.</returns>
        public static IServiceCollection AddSidubAuthenticationForGremlin(
            this IServiceCollection services)
        {
            services.AddSidubAuthentication();
            services.TryAddEnumerable(ServiceDescriptor.Transient<IAuthenticationHandler, GremlinServerAuthenticationHandler>());
